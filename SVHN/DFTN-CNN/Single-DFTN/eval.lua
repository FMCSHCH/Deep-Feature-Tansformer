...
cmd:text()
cmd:text('Options:')
cmd:option('-load', 'results/model.net', 'load saved model as starting point')
cmd:option('-image', '34.png', 'A 1x54x54 image to be classified')
...
image.save('/data/hossamkasem/5-SVHN/original_Exp/test.png', input[1])
