...
local  output_1=torch.Tensor(nbr_samples,3,64,64)
local  output_2=torch.Tensor(nbr_samples,3,64,64)
local  output_3=torch.Tensor(nbr_samples,3,64,64)
local  output_5=torch.Tensor(nbr_samples,3,64,64)
local  output_7=torch.Tensor(nbr_samples,3,64,64)
local  output_10=torch.Tensor(nbr_samples,3,64,64)
count_1=1
count_2=1
count_3=1
count_5=1
