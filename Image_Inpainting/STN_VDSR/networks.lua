...
function networks.new(opt)
  ...
  local network2=nn.ConcatTable()
       network:add(networks.modules.poolingModule(2,2,2,2))        
	  ...
	  network:add(networks.new_spatial_tranformer(opt.locnet,
                                           	 ...
                                           	 false, false, 3)
	local conv2 = networks.new_conv2(64, 100,
                                           	 false, false, 3)										 
	...
	local conv19 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv20 = networks.new_conv2(100, 3,
                                           	 false, false, 3)	
  ...
  network:add(nn.SpatialUpSamplingBilinear(2))
